  ...
  <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-2 gap-4 sm:flex sm:overflow-x-auto sm:snap-x sm:snap-mandatory sm:gap-6 pb-8 hide-scrollbar" style="scrollbar-width: none; -ms-overflow-style: none;">
      ...
      {% if carousel_section and carousel_section.items %}
        ...
        <a href="{{ item.url }}" class="group relative flex-none w-full sm:w-48 md:w-60 lg:w-72 aspect-[3/4] snap-start rounded-2xl overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl bg-gray-200">
