...
blocks:
  - type: text
    body: >-
      ...
      The CanopyMap visualizes all vegetation over one meter in height using a color gradient to represent crown height. This makes it instantly easy to tell the difference between mature woodland and newly planted trees, or to distinguish a tightly cropped agricultural hedge from a wild, overgrown one.


      The canopyMap can be used in many different ways. Key uses include:


      * Reporting on field boundary hedges by measuring maximum, minimum, and average heights, as well as tree counts and gap lengths.

      * Identifying potential veteran trees by comparing present-day canopies with historical locations recorded on 140-year-old Ordnance Survey maps.

      * Quantifying pond shading by overlaying vegetation data to measure how much a water habitat is obscured by overhanging branches.
      ...
      * Providing detailed assessments of hedgerow network connectivity  to support local biodiversity and nature recovery strategies.
      ...
      The foundation of the CanopyMap is the Environment Agency’s National LiDAR Programme data. Between 2017 and 2023, specially equipped planes flew across England, bouncing laser pulses off the landscape to achieve complete, 1-meter resolution coverage of the country. While the primary goal was to help predict flood risks and manage coastal erosion, this rich dataset has incredible value for conservation.
